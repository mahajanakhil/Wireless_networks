...
set f [open 2_out.tr w]
$ns trace-all $f
set namtrace [open 2_out.nam w]
$ns namtrace-all-wireless $namtrace $val(x) $val(y)
set f0 [open aodv_10_received.tr w]
set f1 [open aodv_10_lost.tr w]
...
proc finish {} {
	...
	close $f0
 	...
 	close $f2
        close $f3
        #exec xgraph packets1_received.tr packets1_lost.tr 
                                    # proj_out2.tr proj_out3.tr 
        exec nam -r 5m 2_out.nam &
	exit 0
}
